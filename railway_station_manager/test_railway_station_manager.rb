...
require_relative 'railway_station_manager'
...
module TestRouteHelper
  ...
  def append_stations(route)
    route.append_intermediate_station(@tver_station)
    route.append_intermediate_station(@vyshniy_volochek_station)
    route.append_intermediate_station(@malaya_vishera_station)
  end
  ...
  def all_stations
    [
      @origin_station,
      @tver_station,
      @vyshniy_volochek_station,
      @malaya_vishera_station,
      @destination_station
    ]
  end
end
...
class TestRouteCase < TestCase
  ...
  def setup
    ...
    @tver_station = Station.new('Tver')
    @vyshniy_volochek_station = Station.new('Vyshniy Volochek')
    @malaya_vishera_station = Station.new('Malaya Vishera')
  ...
  def test_append_double_station
    ...
    assert_equal [@origin_station, @tver_station, @destination_station], route.stations
  end
  ...
  def test_remove_intermediate_station
    ...
    route.remove_intermediate_station(@tver_station)
    route.remove_intermediate_station(@malaya_vishera_station)
    route.remove_intermediate_station(@vyshniy_volochek_station)
